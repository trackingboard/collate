...
class MoviesControllerTest < ActionController::TestCase
  ...
  def test_name_filter_on_movies
    ...
    get :index, params: { filter.param_key => 'back' }
  ...
  def test_name_eq_filter_on_movies
    ...
    get :index, params: { filter.param_key => "back to the future" }
  ...
  def test_get_all_scifi_movies
    ...
    get :index, params: { filter.param_key => [@scifi.id] }
  ...
  def test_boolean_filter
    ...
    get :index, params: { filter.param_key => true }
  ...
  def test_date_field_transformations
    ...
    get :index, params: { filter.param_key => 2 }
  ...
  def test_split_field_transformation
    ...
    get :index, params: { filter.param_key => ['biodiesel', 'listicle'] }
  ...
  def test_le_operator
    ...
    get :index, params: { filter.param_key => 6 }
  ...
  def test_array_length
    ...
    get :index, params: { filter.param_key => 11 }
  ...
  def test_null_operator
    ...
    get :index, params: { filter.param_key => 'pizza' }
  ...
  def test_undefined_operator
    ...
    get :index, params: { filter.param_key => 'party' }
  ...
  def test_default_operator_is_in_when_field_ends_in_id
    ...
    get :index, params: { filter.param_key => Director.first.id }
  ...
  def test_model_enum_in
    ...
    get :index, params: { filter.param_key => [Movie::RATINGS.first] }
